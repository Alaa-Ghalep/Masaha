        ...
        <div className="flex-1 flex flex-col justify-center max-w-md mx-auto w-full space-y-6">
          ...
          <form onSubmit={(e) => {e.preventDefault(); navigate('/dashboard');}} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <input type="text" placeholder="أدخل اسمك الكامل" className="w-full bg-white border border-slate-200 rounded-xl py-3 px-5 text-sm focus:outline-none focus:ring-4 focus:ring-[#00BBA7]/10 focus:border-[#00BBA7] transition-all" required />
            </div>

            <div className="space-y-1.5">
              <label className="text-[10px] font-black text-slate-500 pr-2 uppercase">البريد الإلكتروني</label>
              <input type="email" placeholder="masaha@example.com" className="w-full bg-white border border-slate-200 rounded-xl py-3 px-5 text-left text-sm font-sans focus:outline-none focus:ring-4 focus:ring-[#00BBA7]/10 focus:border-[#00BBA7] transition-all" required />
            </div>

            <div className="space-y-1.5">
              <label className="text-[10px] font-black text-slate-500 pr-2 uppercase">رقم الجوال</label>
              <input type="tel" placeholder="+970 59X XXX XXX" className="w-full bg-white border border-slate-200 rounded-xl py-3 px-5 text-left text-sm font-sans focus:outline-none focus:ring-4 focus:ring-[#00BBA7]/10 focus:border-[#00BBA7] transition-all" required />
            </div>
        <div className="space-y-1.5">
              ...
              <div className="relative">
                <input type={showPassword ? "text" : "password"} placeholder="••••••••" className="w-full bg-white border border-slate-200 rounded-xl py-4 px-12 text-left font-sans focus:outline-none focus:ring-4 focus:ring-[#00BBA7]/10 focus:border-[#00BBA7] transition-all" required />
