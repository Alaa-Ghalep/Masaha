        ...
        <div className="flex-1 flex flex-col justify-center max-w-md mx-auto w-full space-y-8">
          ...
          <form onSubmit={(e) => {e.preventDefault(); navigate('/dashboard');}} className="space-y-6">
            <div className="space-y-2">
              ...
              <input type="email" placeholder="user@masaha.ps" className="w-full bg-white border border-slate-200 rounded-xl py-4 px-5 text-left font-sans focus:outline-none focus:ring-4 focus:ring-[#00BBA7]/10 focus:border-[#00BBA7] transition-all" required />
            </div>
        ...
        <div className="flex justify-between items-center px-2">
           <div className="flex items-center gap-2 px-2">
              ...
              <label htmlFor="remember" className="text-xs font-bold text-slate-500 cursor-pointer">تذكرني لمدة 30 يوماً</label>
                ...
                <button type="button" className="text-[10px] font-black text-red-400 hover:underline cursor-pointer">نسيت كلمة المرور؟</button>
              </div>         
