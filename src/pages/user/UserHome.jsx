...
const UserHome = () => {
  ...
  const spaces = [
    { id: 1, name: 'مساحة الإبداع', price: 15, region: 'غزة', speed: '180 ', seats :'20', active: '12 متاح', rating: 4.8 },
    { id: 2, name: 'مساحة المستقبل', price: 12, region: 'الوسطى', speed: '150 ', seats :'30', active: '8 متاح', rating: 4.6 },
    { id: 3, name: 'مساحة الريادة', price: 20, region: 'غزة', speed: '200 ', seats :'20', active: '5 متاح', rating: 4.9 },
    { id: 4, name: 'مساحة التطوير', price: 10, region: 'الجنوب', speed: '80 ',seats :'40', active: '15 متاح', rating: 4.5 },
  ];
  ...
  return (
    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-[var(--primary)] via-[#3AAFA6] to-[var(--primary-hover)] rounded-[32px] p-8 md:p-12 text-white">
        <div className="relative z-10 space-y-2">
          ...
          <h1 className="text-3xl md:text-4xl font-black">أحمد محمد</h1>
      ...
      <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
        {categories.map((cat, i) => (
          <button key={cat} className={`px-8 py-2.5 rounded-full text-sm font-bold transition-all ${i === 0 ? 'bg-[#009689] text-white shadow-lg shadow-[#009689]/30' : 'bg-white text-slate-500 border border-slate-100 hover:bg-slate-50'}`}>
            {cat}
          </button>
        ))}
      </div>
    ...
    <div className="p-4 space-y-4">
      ...
      <div className="flex justify-between items-center pt-2 border-t border-slate-100">
        ...
        <span className="text-[10px] text-slate-400 font-medium">
          {space.seats} مقعد • Mbps {space.speed} 
        </span>
      </div>
    </div>
  </div>
