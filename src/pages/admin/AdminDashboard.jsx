...
const AdminDashboard = () => {
  const stats = [
    { label: 'إجمالي المستخدمين', value: '1,246', change: '+ 8% هذا الشهر', icon: <RiUserLine />, color: 'bg-emerald-500' },
  ...
  return (
    <div className="space-y-10 font-['Cairo']">
     ...
     <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((s, i) => (
          <div key={i} className="bg-white px-6 py-4 rounded-[32px] border border-slate-100 shadow-sm flex items-center justify-between gap-5">
